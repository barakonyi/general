...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Ref(x1)) {
      ...
      var name = x3.name$2;
      if ((name !== null)) {
        var x1$2 = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references);
        if ($is_Lcalculator_Ref(x1$2)) {
          var x2$2 = $as_Lcalculator_Ref(x1$2);
          var x$3 = expr;
          if (((x2$2 === null) ? (x$3 === null) : x2$2.equals__O__Z(x$3))) {
            return (NaN)
          } else {
          ...
          var temp$references$2 = $as_sci_Map(references.$$minus__O__sc_Map(name));
          expr = x1$2;
          references = temp$references$2;
          continue _eval
        } else {
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    return new $c_T2().init___O__O(k, new $c_Lcalculator_Signal().init___F0(expr))
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
